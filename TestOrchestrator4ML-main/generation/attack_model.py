...
def calculate_k(X_train, X_test, y_train, y_test):
    ...
    log2 = forensic_logging.getLoggerObj()
    ...
    # Once the for-loop is finished log the value of accuracies
    log2.debug('{}*{}*{}'.format('attack_model.py', 'calculate_k', str(accuracies)))
